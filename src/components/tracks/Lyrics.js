...
class Lyrics extends Component {
    ...
    //component level state here because we need this data in this component only which is directly fetched from server
    ...
    render() {
        ...
        if(this.state.track === undefined || lyrics === undefined || Object.keys(track).length === 0 || Object.keys(lyrics).length === 0){
            return <Spinner/>
        }else{
            return (
                <>
